...
export default function Home() {
  return (
    <main className="bg-pxlcorp min-h-screen relative px-6 py-10 md:p-12 lg:p-16 flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row justify-between flex-1">
        ...
        <div className="flex flex-col lg:max-w-2xl">
          ...
          <div className="mt-12 lg:mt-16 space-y-6 md:space-y-5 lg:space-y-6 
            ...
            {/* pxlcorp & friends link */}
            <Link href="/friends" className="file-link flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-3 lg:gap-4 cursor-pointer group animate-fade-in-up delay-700">
              <div className="w-10 h-12 md:w-8 md:h-10 lg:w-12 lg:h-14 relative flex-shrink-0">
                <Image
                  src="/icons/file icon.svg"
                  alt="file icon"
              ...
              <span className="font-jersey text-white text-lg sm:text-xl md:text-lg lg:text-xl transition-colors duration-200 group-hover:text-pxl-red whitespace-nowrap">pxlcorp & friends.exe</span>
            </Link>
          </div>
        </div>
